...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Course'
        db.create_table(u'score_keeper_course', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=455)),
            ('par', self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'score_keeper', ['Course'])
        ...
        db.create_table(u'score_keeper_scorecard', (
            ...
            ('baskets', self.gf('django.db.models.fields.IntegerField')()),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'score_keeper_course')
    ...
    models = {
        ...
        u'score_keeper.scorecard': {
            'Meta': {'object_name': 'ScoreCard'},
            'baskets': ('django.db.models.fields.IntegerField', [], {}),
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['score_keeper.Course']"}),
